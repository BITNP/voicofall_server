...
namespace voicofall_server
{
    public partial class changeTime : System.Web.UI.Page
    {
        ...
        protected void changeButton_Click(object sender, EventArgs e)
        {
            ...
            if (Page.IsValid)
            {
                DataRow drow = ticketsStateTable.Rows.Find("nextBookTime");
        ...
        private void ShowTime()
        {
            ...
            int booksecond = 0;
            this.nowTimeLable.Text = String.Format("{0}年{1}月{2}日 {3}:{4:00}:{5:00}", bookyear, bookmonth, bookday, bookhour, bookmin, booksecond);
        }
